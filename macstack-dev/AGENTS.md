...
This plugin ships `hooks/hooks.json`. After installing, run `/hooks` to trust it before its hooks will run. Note: `PreToolUse.additionalContext` is currently ignored by Codex.
