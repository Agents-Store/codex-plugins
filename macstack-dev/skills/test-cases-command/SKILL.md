---
name: test-cases
description: 'Derive TEST-CASES.md from the acceptance bullets of USER-CASES.md, or re-derive it after a version bump Arguments: [case id, role letter, or empty for all].'
---
