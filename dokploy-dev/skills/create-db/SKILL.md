---
name: create-db
description: 'Create and deploy a database in a Dokploy project Arguments: <name> --project <project> --type <postgres|mysql|mariadb|mongo|redis|libsql> [--password <pass>].'
---
