...
- **[DEPENDENCIES.md](references/DEPENDENCIES.md)** - Deep dive into property dependencies and displayOptions
- **[OPERATION_PATTERNS.md](references/OPERATION_PATTERNS.md)** - Common configuration patterns by node type
