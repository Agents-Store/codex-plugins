...
description: 'Search the official n8n template library for ready-made workflows Arguments: <query> [--category <name>] [--nodes <nodeTypes>] [--mode <keyword|by_nodes|by_task>].'
---
