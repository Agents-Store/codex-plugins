...
- 12 skill(s) under `skills/` (includes 7 command(s) converted to skills — Codex has no custom slash-command system)
- 4 subagent definition(s) under `agents/` — **not installed automatically by Codex**. Copy manually:
