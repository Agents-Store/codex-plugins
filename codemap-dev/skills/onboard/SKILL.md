---
name: onboard
description: 'Generate a full onboarding report — README summary, stack, folder structure, entry points, how to run locally, and 3 main diagrams (architecture, main flow, DB) Arguments: (no arguments — analyzes current project).'
---
