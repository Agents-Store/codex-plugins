---
name: scaffold
description: 'Scaffold a fresh PayloadCMS v3 project with create-payload-app, walking through database adapter, template, and package manager choices. Arguments: project-name.'
---
