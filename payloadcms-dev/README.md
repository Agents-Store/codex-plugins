...
```bash
codex plugin marketplace add agents-store/payloadcms-dev-codex
```
...
- 24 skill(s) under `skills/` (includes 1 command(s) converted to skills — Codex has no custom slash-command system)
