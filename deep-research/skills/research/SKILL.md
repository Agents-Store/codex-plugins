---
name: research
description: 'Conduct comprehensive deep research on a topic using 7-step algorithm Arguments: <topic> [--type <competitive|market|technical|person|topic|news>] [--depth <quick|standard|deep>].'
---
