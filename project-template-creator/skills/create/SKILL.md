---
name: create
description: 'Create a new project template at Level 1, 1.5, or 2 by cloning and customizing a parent template Arguments: Template description (e.g., ''Level 1 template for Directus + Next.js'', ''demo for Supabase + Nuxt'').'
---
