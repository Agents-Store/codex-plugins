...
description: 'Optimize a specific OpenClaw workspace file or all files at once, with security checks and optional openclaw.json editing Arguments: <soul|agents|user|tools|heartbeat|identity|memory|bootstrap|boot|config|all>.'
---
