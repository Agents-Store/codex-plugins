---
name: workspace-scan
description: 'Quick health check of OpenClaw instance — scans all categories (A–J), checks sizes, detects inline secrets, identifies missing components, verifies language Arguments: [quick|full|security].'
---
