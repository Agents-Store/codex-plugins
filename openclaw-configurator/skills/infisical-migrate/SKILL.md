---
name: infisical-migrate
description: 'Migrate an OpenClaw instance''s secrets from plaintext .env into self-hosted Infisical and wire the Docker stack to inject them at runtime. Prompts for the Infisical project id; pushes sensitive keys; patches Dockerfile/compose/wrapper; rebuilds; strips plaintext; audits. Arguments: [infisical-project-id].'
---
