...
description: 'Generate copy-paste curl scripts for a Dify operation (chat, completion, workflow, file upload, knowledge-base ingest/retrieve) Arguments: [operation].'
---
