...
The root `.agents/plugins/marketplace.json` registers this repository as the `agents-store-codex-plugins` marketplace. Add it, then install any plugin below by name:

```bash
codex plugin marketplace add <repo>
codex plugin add <plugin-name>@agents-store-codex-plugins
```
