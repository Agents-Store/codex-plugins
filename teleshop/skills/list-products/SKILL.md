---
name: list-products
description: 'List products with optional search, category, status, and limit filters Arguments: [--search <query>] [--category <name>] [--status available|unavailable|preorder] [--limit <n>].'
---
